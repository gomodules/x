...
func (l *Logger) Fatalln(args ...interface{}) {
	glog.FatalDepth(1, l.ctx, fmt.Sprintln(args...))
}
...
func (l *Logger) Errorln(args ...interface{}) {
	glog.ErrorDepth(1, l.ctx, fmt.Sprintln(args...))
}
...
func (l *Logger) Warningln(args ...interface{}) {
	glog.WarningDepth(1, l.ctx, fmt.Sprintln(args...))
}
...
func (l *Logger) Infoln(args ...interface{}) {
	glog.InfoDepth(1, l.ctx, fmt.Sprintln(args...))
}
